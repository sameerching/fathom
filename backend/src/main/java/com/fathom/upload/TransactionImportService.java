...
public class TransactionImportService {
    ...
    private TransactionImportDtos.ImportSummaryResponse toSummary(TransactionImport i,List<TransactionImportDtos.ImportErrorResponse> errs){ return new TransactionImportDtos.ImportSummaryResponse(i.getId(),i.getSource(),i.getOriginalFilename(),i.getStatus(),i.getTotalRows(),i.getCreatedCount(),i.getSkippedDuplicateCount(),i.getFailedCount(),errs,i.getCreatedAt(),i.getUpdatedAt()); }
